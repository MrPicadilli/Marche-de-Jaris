...
namespace SVG {
    ...
    inline void Element::autoscale(const double margin) {
        ...
        this->get_bbox(bbox);
        double width = abs(bbox.x1 - bbox.x2),
            height = abs(bbox.y1 - bbox.y2);
    ...
    inline void Element::autoscale(const Margins& margins) {
        ...
        double width = abs(bbox.x1 - bbox.x2) + margins.x1 + margins.x2,
            height = abs(bbox.y1 - bbox.y2) + margins.y1 + margins.y2,
